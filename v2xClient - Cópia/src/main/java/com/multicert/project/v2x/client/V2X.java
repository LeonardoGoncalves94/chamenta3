...
public interface V2X {
	...
	/**
	 * method to generate an certificate hashed id 8 with the SHA-256 algorithm
	 */
	HashedId8 genCertificateHashedId8(EtsiTs103097Certificate certificate) throws NoSuchAlgorithmException, IOException;
	
	/**
	 * method to generate an certificate hashed id 3 with the SHA-256 algorithm
	 */
	HashedId3 genCertificateHashedId3(EtsiTs103097Certificate certificate) throws NoSuchAlgorithmException, IOException;
	...
	List<HashedId3> getRequestedCerts(EtsiTs103097Data signData) throws BadContentTypeException;
}
