...
public class V2XImpl implements V2X {
	...
	@Override
	public HashedId8 genCertificateHashedId8(EtsiTs103097Certificate certificate) throws NoSuchAlgorithmException, IOException 
	{
		return new HashedId8(cryptoHelper.getCertificateHashId(certificate,  HashAlgorithm.SHA_256).getHashedId());
	}
	
	@Override
	public HashedId3 genCertificateHashedId3(EtsiTs103097Certificate certificate) throws NoSuchAlgorithmException, IOException 
	{
