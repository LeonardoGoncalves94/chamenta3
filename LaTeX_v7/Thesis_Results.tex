...
\begin{table}
	...
	\begin{figure}
		\begin{subfigmatrix}{2}
			\subfigure[Vehicle Configuration]{\includegraphics[width=0.49\linewidth]{Figures/conf_graph.png}}
			\subfigure[Vehicle Enrollment]{\includegraphics[width=0.49\linewidth]{Figures/enroll_graph.png}}
			\subfigure[Vehicle Authorization w/o enrollment validation]{\includegraphics[width=0.49\linewidth]{Figures/new_auth_graph.png}}
			\subfigure[Vehicle Authorization]{\includegraphics[width=0.49\linewidth]{Figures/auth_graph.png}}
		\end{subfigmatrix}
